---
title: EXAMPLES
description: Example Anamnesis Capsules and usage patterns
---

## Overview

This section provides example Anamnesis Capsules for testing, learning, and reference implementations.

:::note[Informative ⟂]
All examples are available as JSON files at `/examples/` and can be used for:

- Learning the Anamnesis Capsule structure
...
The simplest valid Anamnesis Capsule with only required fields.
...
A more realistic Anamnesis Capsule with multiple artifacts and common patterns.
...
```bash
# Minimal
curl https://claaaaaw.github.io/namnesis/examples/minimal.json

# Typical
curl https://claaaaaw.github.io/namnesis/examples/typical.json
```

:::note
Example files include full valid Anamnesis Capsule structures with placeholder hashes and signatures. They are for structural reference, not cryptographic verification.
:::
