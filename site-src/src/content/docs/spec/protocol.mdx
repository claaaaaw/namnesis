---
title: Protocol
description: Wire format and operations for NAMNESIS Anamnesis Protocol
---

## Overview

This document specifies the operations and data flows for NAMNESIS Anamnesis Capsule management (Imprint and Anamnesis rituals).
