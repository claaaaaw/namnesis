...
|------|-------------|--------------|
| `capsule.manifest.schema.json` | Anamnesis Capsule metadata | `application/schema+json` |
...
```json
{
  "$schema": "https://claaaaaw.github.io/namnesis/schemas/v1/capsule.manifest.schema.json",
  "example_id": "minimal",
  "expected_valid": true,
  "notes": "Minimum fields for a valid Anamnesis Capsule",
  "manifest": {
...
curl -H "Accept: application/json" \
  https://claaaaaw.github.io/namnesis/.well-known/manifest.json

# Fetch schema
curl -H "Accept: application/schema+json" \
  https://claaaaaw.github.io/namnesis/schemas/v1/capsule.manifest.schema.json
```
