...
Conformance testing ensures implementations correctly follow the NAMNESIS specification (Dogma and Anamnesis Protocol).
...
| Test | Input | Expected |
|------|-------|----------|
| `export-minimal` | Simple workspace | Valid Anamnesis Capsule |
| `import-minimal` | Minimal Anamnesis Capsule | Restored workspace |
