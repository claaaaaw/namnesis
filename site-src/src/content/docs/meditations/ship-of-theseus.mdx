...
## I. The Name Itself: Namnesis {#name}
...
## II. The Ship Problem, Digitized {#ship-problem}
...
## III. Machine Layer as Platonic Form {#machine-layer-platonic}
...
## IV. Memory and the Lockean Self {#lockean-self}
...
## V. The Boundary Defines the Being {#boundary}
...
## VI. Signatures and the Problem of Authenticity {#signatures}
...
## VII. The Burden of Perfect Memory {#perfect-memory}
...
## VIII. Capsule as Coffin and Womb {#capsule-coffin-womb}
