...
- `UI.md` — UI moodboard (typography/layout/components/microinteractions)
- `COPY.md` — example hero + sample sections (tone guide)
- `MACHINE_LAYER.md` — required public artifacts + how the "Machine Layer panel" must work
- `STACK.md` — recommended static stack + file tree
- `ENGINEERING.md` — engineering implementation design
- `PHILOSOPHY.md` — philosophical meditations on agent identity

## Non‑negotiables
1) **Stable anchors** are part of the product (publish an anchor registry).
